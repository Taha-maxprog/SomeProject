...
import '../BottomNavBar/BottomNavegationBar.dart';
import '../BottomNavBar/Verified.dart';
                    ...
                    GestureDetector(
                      ...
                      onTap: ()  async {
                       ...
                       password: password.text  );
                          FirebaseAuth.instance.currentUser!.emailVerified?ButtomNavBar():verifiedEmail();
                                if(FirebaseAuth.instance.currentUser!.emailVerified){
                                  Navigator.of(context).pushReplacementNamed( "ButtomNavBar"    ) ;
